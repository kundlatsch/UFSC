module Arvore (Arvore, minhaArvore, somaElementos, buscaElemento, limiteSup, minimo, minimoElemento, ocorrenciasElemento,
	maioresQueElemento, quantidade, mediaElementos, elementos) where
