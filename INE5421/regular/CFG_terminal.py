...
class CFGTerminal:
    ...
    def create_grammar(self, name):
        if name in self.temp_grammar:
            print('Erro: já existe uma CFG com esse nome')
        else:
            new_grammar = CFG(name)
